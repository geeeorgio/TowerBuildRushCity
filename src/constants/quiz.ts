...
export const GAME_QUIZ: QuizType[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Follow safety rules and use protective equipment',
      'Ignore instructions',
      'Rush',
    ],
    correctValue: 'Follow safety rules and use protective equipment',
  },
];

export const QUIZ_START_TEXT = {
  title: 'Test your knowledge',
  description:
    'Complete 5 questions and if you answer 3+ questions correctly, you get a wallpaper',
  btn_text: 'Start Quiz',
};
...
export const QUIZ_RESULTS_TEXT = [
  {
    ...
    minScore: 0,
    maxScore: 2,
    description: `You answered less than 3 questions correctly. Therefore, you will not receive the wallpaper. I'm sure you will be luckier next time.`,
    btn_text: 'Share',
  },
  {
    id: 'ok',
    ...
    maxScore: 5,
    description:
      'You answered 3 or more out of 5 questions correctly. Therefore, you will receive wallpapers. You can review them in the "Collection" section',
    btn_text: 'Share',
  },
];
